...
serialIntervalData2 <-  read.csv("/Users/rnt22/Documents/HackoutCode/datasets/PennsylvaniaH1N12009SerialIntervalData.csv", header = FALSE)
...
casesPerDayData <- read.csv("/Users/rnt22/Documents/HackoutCode/datasets/PennsylvaniaH1N12009FluData.csv", header = FALSE)
