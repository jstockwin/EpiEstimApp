...
dataMatrix <- rename(dataMatrix, c("V1" = "Individual ID", "V2" = "I1L", "V3" = "I1R", "V4" = "I2L", "V5" = "I2R"))

currentStatus <- matrix(0, nrow = N, ncol = 2)
currentStatus <- as.data.frame(currentStatus)
currentStatus <- rename(currentStatus, c("V1" = "Individual ID", "V2" = "Current status"))  # 0=susceptible, 1=exposed, 2=infected, 3=removed
...
casesPerDay <- rename(casesPerDay, c("V1" = "Time", "V2" = "Cases"))
