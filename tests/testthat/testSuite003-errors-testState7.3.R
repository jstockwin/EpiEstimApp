...
tryCatch({
  ...
  test_that("Giving an invalid mean_si throws correct error", {
    ...
    sendKeys(remDr, pages$state7.3$selectors$mean_siInput, "-1")
    clickGo(remDr)
    checkError(remDr, "mean_si must be greater than or equal to 1", "mean_si")
    clear(remDr, pages$state7.3$selectors$mean_siInput)
    sendKeys(remDr, pages$state7.3$selectors$mean_siInput, "0.99")
    clickGo(remDr)
    checkError(remDr, "mean_si must be greater than or equal to 1", "mean_si")
    clear(remDr, pages$state7.3$selectors$mean_siInput)
    clickGo(remDr)
  ...
  test_that("Giving an invalid min_mean_si throws correct error", {
    ...
    checkError(remDr, "min_mean_si must be greater than or equal to 1", "min_mean_si")
    clear(remDr, pages$state7.3$selectors$min_mean_siInput)
    sendKeys(remDr, pages$state7.3$selectors$min_mean_siInput, "2.5")
    clickGo(remDr)
  ...
  test_that("Giving an invalid max_mean_si throws correct error", {
    ...
    sendKeys(remDr, pages$state7.3$selectors$max_mean_siInput, "-1")
    clickGo(remDr)
    checkError(remDr, "max_mean_si must be greater than or equal to 1", "max_mean_si")
    clear(remDr, pages$state7.3$selectors$max_mean_siInput)
    sendKeys(remDr, pages$state7.3$selectors$max_mean_siInput, "0.99")
    clickGo(remDr)
    checkError(remDr, "max_mean_si must be greater than or equal to 1", "max_mean_si")
    clear(remDr, pages$state7.3$selectors$max_mean_siInput)
    clickGo(remDr)
    checkError(remDr, "max_mean_si must be greater than or equal to 1", "max_mean_si")
    clear(remDr, pages$state7.3$selectors$max_mean_siInput)
    sendKeys(remDr, pages$state7.3$selectors$max_mean_siInput, "1.5")
    clickGo(remDr)
    ...
    # Reset
    clear(remDr, pages$state7.3$selectors$max_mean_siInput)
    sendKeys(remDr, pages$state7.3$selectors$max_mean_siInput, "3")
  })

  test_that("Giving an invalid std_mean_si throws correct error", {
    clear(remDr, pages$state7.3$selectors$std_mean_siInput)
    sendKeys(remDr, pages$state7.3$selectors$std_mean_siInput, "-1")
    clickGo(remDr)
  ...
  test_that("Giving an invalid std_si throws correct error", {
    ...
    sendKeys(remDr, pages$state7.3$selectors$std_siInput, "-1")
    clickGo(remDr)
  ...
  test_that("Giving an invalid min_std_si throws correct error", {
    ...
    checkError(remDr, "min_std_si must be greater than 0", "min_std_si")
    clear(remDr, pages$state7.3$selectors$min_std_siInput)
    sendKeys(remDr, pages$state7.3$selectors$min_std_siInput, "2.5")
    clickGo(remDr)
  ...
  test_that("Giving an invalid max_std_si throws correct error", {
    ...
    sendKeys(remDr, pages$state7.3$selectors$max_std_siInput, "-1")
    clickGo(remDr)
    ...
    checkError(remDr, "max_std_si must be greater than 0", "max_std_si")
    clear(remDr, pages$state7.3$selectors$max_std_siInput)
    sendKeys(remDr, pages$state7.3$selectors$max_std_siInput, "1.5")
    clickGo(remDr)
    ...
    # Reset
    clear(remDr, pages$state7.3$selectors$max_std_siInput)
    sendKeys(remDr, pages$state7.3$selectors$max_std_siInput, "3")
  })

  test_that("Giving an invalid std_std_si throws correct error", {
    clear(remDr, pages$state7.3$selectors$std_std_siInput)
    sendKeys(remDr, pages$state7.3$selectors$std_std_siInput, "-1")
    clickGo(remDr)
