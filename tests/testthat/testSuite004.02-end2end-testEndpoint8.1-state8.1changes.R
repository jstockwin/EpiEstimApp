...
test_that("Test 6 output matches", {
  ...
  epiEstimOut <- EstimateR(I, t_start=2:26, t_end=8:32, si_sample=sample, method="si_from_sample", n2=50, seed=1)
...
test_that("Test 7 output matches", {
  ...
  epiEstimOut <- EstimateR(I, t_start=2:26, t_end=8:32, si_sample=sample, method="si_from_sample", n2=100, seed=2)
