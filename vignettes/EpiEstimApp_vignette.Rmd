...
The example that follows will use disease incidence time series (XXX.csv) and interval-censored observations of the serial interval (XXX.csv), which are datasets available at XXX. Save these on your computer.
...
We have now obtained an estimate of the reproduction number throughout the outbreak of XXX in XXX.
