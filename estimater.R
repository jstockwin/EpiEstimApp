                            ...
                            plot = FALSE, leg.pos = "topright")
{
  ...
  EpiEstim:::check_times(T.Start, T.End)
  NbTimePeriods <- length(T.Start)
  ...
  if (plot) {
    ...
    {
      p1 <- plot(incidence:::as.incidence(I), ylab="Incidence", xlab = "Time") +
        ggtitle("Epidemic curve")
    }else
    {
      p1 <- plot(incidence:::as.incidence(rowSums(I)), ylab="Incidence", xlab = "Time") +
        ggtitle("Epidemic curve")
    }
